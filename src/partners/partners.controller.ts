...
export class PartnersController {
  ...
  async partnerLogin(
    ...
    try {
      const usernameLiteral = this.escapeXPathLiteral(username);
      const passwordLiteral = this.escapeXPathLiteral(password);
  ...
  async searchPartners(@Query('keyword') keyword: string): Promise<string> {
    ...
    try {
      const keywordLiteral = this.escapeXPathLiteral(keyword);
